...
public class GlowWitchHut extends GlowTemplePiece {
    ...
    public boolean generate(World world, Random random, StructureBoundingBox genBoundingBox,
        ...
        builder.fill(new Vector(1, 1, 2), new Vector(5, 4, 7), Material.SPRUCE_PLANKS, 1,
            Material.AIR); // hut body
        builder.fill(new Vector(1, 1, 1), new Vector(5, 1, 1), Material.SPRUCE_PLANKS, 1); // hut steps
        builder.fill(new Vector(2, 1, 0), new Vector(4, 1, 0), Material.SPRUCE_PLANKS, 1); // hut steps
