...
public class OrePopulator extends BlockPopulator {
    ...
    public OrePopulator() {
        ores.put(new OreType(Material.DIRT, 0, 0, 256, 32), 10);
        ores.put(new OreType(Material.GRAVEL, 0, 0, 256, 32), 8);
        ores.put(new OreType(Material.STONE, 1, 0, 80, 32), 10);
        ores.put(new OreType(Material.STONE, 3, 0, 80, 32), 10);
        ores.put(new OreType(Material.STONE, 5, 0, 80, 32), 10);
        ores.put(new OreType(Material.COAL_ORE, 0, 0, 128, 16), 20);
        ores.put(new OreType(Material.IRON_ORE, 0, 0, 64, 8), 20);
        ores.put(new OreType(Material.GOLD_ORE, 0, 0, 32, 8), 2);
        ores.put(new OreType(Material.REDSTONE_ORE, 0, 0, 16, 7), 8);
        ores.put(new OreType(Material.DIAMOND_ORE, 0, 0, 16, 7), 1);
        ores.put(new OreType(Material.LAPIS_ORE, 0, 16, 16, 6), 1);
    }
