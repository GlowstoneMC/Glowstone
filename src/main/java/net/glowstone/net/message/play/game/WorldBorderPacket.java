...
public final class WorldBorderPacket implements Message {
    ...
    // SET_SIZE
    public WorldBorderPacket(Action action, double radius) {
        this(action, radius, 0, 0, 0, 0, 0, 0, 0, 0);
    }

    // LERP_SIZE
    public WorldBorderPacket(Action action, double oldRadius, double newRadius, long speed) {
        this(action, 0, oldRadius, newRadius, speed, 0, 0, 0, 0, 0);
    }

    // SET_CENTER
    public WorldBorderPacket(Action action, double x, double z) {
        this(action, 0, 0, 0, 0, x, z, 0, 0, 0);
    }

    // INITIALIZE
    public WorldBorderPacket(Action action, double x, double z, double oldRadius, double newRadius, long speed, int portalTeleportBoundary, int warningTime, int warningBlocks) {
    ...
    public WorldBorderPacket(Action action, int warning) {
