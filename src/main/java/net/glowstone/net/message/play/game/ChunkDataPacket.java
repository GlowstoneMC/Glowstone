...
@Data
public final class ChunkDataPacket extends ChunkDataLegacyMessage implements Message {

    private final CompoundTag[] tileEntities;

    public ChunkDataPacket(int x, int z, boolean continuous, int primaryMask, ByteBuf data, CompoundTag[] tileEntities) {
