...
public final class ResourcePackSendCodec implements Codec<ResourcePackSendMessage> {
    ...
    @Override
    public ResourcePackSendMessage decode(CodecContext codecContext, ByteBuf buffer) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, ResourcePackSendMessage message) throws IOException {
