...
public final class EntityEffectCodec implements Codec<EntityEffectMessage> {
    ...
    @Override
    public EntityEffectMessage decode(CodecContext codecContext, ByteBuf buf) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, EntityEffectMessage message) throws IOException {
