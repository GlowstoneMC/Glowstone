...
public final class TabCompleteResponseCodec implements Codec<TabCompleteResponsePacket> {
    @Override
    public TabCompleteResponsePacket decode(ByteBuf buf) throws IOException {
        throw new DecoderException("Cannot decode TabCompleteResponseMessage");
    }

    @Override
    public ByteBuf encode(ByteBuf buf, TabCompleteResponsePacket message) throws IOException {
