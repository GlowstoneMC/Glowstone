...
public class AdvancementsCodec implements Codec<AdvancementsMessage> {
    ...
    @Override
    public AdvancementsMessage decode(CodecContext codecContext, ByteBuf buf) throws IOException {
        throw new UnsupportedOperationException("Cannot decode AdvancementsMessage");
    }

    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, AdvancementsMessage message) throws IOException {
