...
public final class HealthCodec implements Codec<HealthMessage> {
    ...
    @Override
    public HealthMessage decode(CodecContext codecContext, ByteBuf buffer) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, HealthMessage message) throws IOException {
