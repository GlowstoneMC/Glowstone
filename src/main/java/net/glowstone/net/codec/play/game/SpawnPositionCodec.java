...
public final class SpawnPositionCodec implements Codec<SpawnPositionMessage> {
    ...
    @Override
    public SpawnPositionMessage decode(CodecContext codecContext, ByteBuf buffer) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, SpawnPositionMessage message) throws IOException {
