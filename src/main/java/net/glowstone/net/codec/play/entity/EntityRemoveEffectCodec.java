...
public final class EntityRemoveEffectCodec implements Codec<EntityRemoveEffectMessage> {
    ...
    @Override
    public EntityRemoveEffectMessage decode(CodecContext codecContext, ByteBuf buf) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, EntityRemoveEffectMessage message) throws IOException {
