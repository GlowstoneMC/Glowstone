...
public final class PlayParticleCodec implements Codec<PlayParticleMessage> {
    ...
    @Override
    public PlayParticleMessage decode(CodecContext codecContext, ByteBuf buf) throws IOException {
        throw new DecoderException("Cannot decode PlayParticleMessage");
    }

    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, PlayParticleMessage message) throws IOException {
