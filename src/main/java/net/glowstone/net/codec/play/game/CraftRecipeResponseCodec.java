...
public final class CraftRecipeResponseCodec implements Codec<CraftRecipeResponseMessage> {
    ...
    @Override
    public CraftRecipeResponseMessage decode(CodecContext codecContext, ByteBuf buf) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, CraftRecipeResponseMessage message) throws IOException {
