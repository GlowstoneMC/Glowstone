...
public final class EntityMetadataCodec implements Codec<EntityMetadataMessage> {
    ...
    @Override
    public EntityMetadataMessage decode(CodecContext codecContext, ByteBuf buf) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, EntityMetadataMessage message) throws IOException {
