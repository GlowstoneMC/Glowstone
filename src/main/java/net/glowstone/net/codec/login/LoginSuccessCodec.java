...
public final class LoginSuccessCodec implements Codec<LoginSuccessMessage> {
    ...
    @Override
    public LoginSuccessMessage decode(CodecContext codecContext, ByteBuf buffer) throws IOException {
    ...
    @Override
    public ByteBuf encode(CodecContext codecContext, ByteBuf buf, LoginSuccessMessage message) throws IOException {
