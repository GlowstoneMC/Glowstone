...
public class WorldBorderCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("center")) {
            if (args.length < 3) {
                sender.sendMessage(I.tr(sender, "command.generic.usage", "/worldborder center <x> <z>"));
                return false;
            }
            if (sender instanceof Player) {
                ...
                try {
                    ...
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.invalid.center"));
                    return false;
                }
                for (World world : Bukkit.getWorlds()) {
            ...
            if (args.length < 2) {
                sender.sendMessage(I.tr(sender, "command.generic.usage", I.tr(sender, "command.minecraft.worldborder.usage.set")));
                return false;
            }
            double size;
            try {
                ...
                sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.invalid.size"));
                return false;
            }
            int time = 0;
            if (args.length > 2) {
            ...
            if (time < 0) {
                sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.positive.size"));
                return false;
            }
            for (World world : Bukkit.getWorlds()) {
            ...
            if (args.length < 2) {
                sender.sendMessage(I.tr(sender, "command.generic.usage", I.tr(sender, "command.minecraft.worldborder.usage.add")));
                return false;
            }
            double size;
            try {
            ...
            if (args.length < 2) {
                sender.sendMessage(I.tr(sender, "command.generic.usage", "/worldborder damage <buffer|amount> ..."));
                return false;
            }
            if (args[1].equalsIgnoreCase("buffer")) {
                if (args.length < 3) {
                    sender.sendMessage(I.tr(sender, "command.generic.usage", I.tr(sender, "command.minecraft.worldborder.usage.buffer")));
                    return false;
                }
                double buffer;
                try {
                    ...
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.invalid.buffer"));
                    return false;
                }
                if (buffer < 0) {
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.positive.buffer"));
                    return false;
                }
                for (World world : Bukkit.getWorlds()) {
                ...
                if (args.length < 3) {
                    sender.sendMessage(I.tr(sender, "command.generic.usage", I.tr(sender, "command.minecraft.worldborder.usage.amount")));
                    return false;
                }
                double damage;
                try {
                    ...
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.invalid.amount"));
                    return false;
                }
                if (damage < 0) {
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.positive.amount"));
                    return false;
                }
                for (World world : Bukkit.getWorlds()) {
            ...
            if (args.length < 2) {
                sender.sendMessage(I.tr(sender, "command.generic.usage", "/worldborder warning <time|distance> ..."));
                return false;
            }
            if (args[1].equalsIgnoreCase("time")) {
                if (args.length < 3) {
                    sender.sendMessage(I.tr(sender, "command.generic.usage", I.tr(sender, "command.minecraft.worldborder.usage.time")));
                    return false;
                }
                int time;
                try {
                    ...
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.invalid.time"));
                    return false;
                }
                if (time < 0) {
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.positive.time"));
                    return false;
                }
                for (World world : Bukkit.getWorlds()) {
                ...
                if (args.length < 3) {
                    sender.sendMessage(I.tr(sender, "command.generic.usage", I.tr(sender, "command.minecraft.worldborder.usage.distance")));
                    return false;
                }
                int blocks;
                try {
                    ...
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.invalid.distance"));
                    return false;
                }
                if (blocks < 0) {
                    sender.sendMessage(I.tr(sender, "command.minecraft.worldborder.positive.distance"));
                    return false;
                }
                for (World world : Bukkit.getWorlds()) {
