...
public class PlaySoundCommand extends VanillaCommand {
    ...
    public PlaySoundCommand() {
        super("playsound", GlowServer.lang.getString("command.minecraft.playsound.description"), GlowServer.lang.getString("command.minecraft.playsound.usage"), Collections.emptyList());
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (args.length < 3 || args.length == 4 || args.length == 5) {
            sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.generic.usage", GlowServer.lang.getString(sender, "command.minecraft.playsound.usage")));
            return false;
        }
        ...
        if (sound == null) {
            sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.minecraft.playsound.invalid.sound", stringSound));
            return false;
        }

        if (soundCategory == null) {
            sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.minecraft.playsound.invalid.category", stringCategory));
            return false;
        }
        ...
        if (playerPattern.startsWith("@") && playerPattern.length() > 1 && CommandUtils.isPhysical(sender)) { // Manage selectors
            ...
            if (player == null) {
                sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.generic.player.missing", playerPattern));
                return false;
            } else {
        ...
        if (args.length >= 9) {
            try {
                ...
                if (minimumVolume < 0 || minimumVolume > 1) {
                    sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.minecraft.playsound.invalid.volume", args[8]));
                    return false;
                }
            } catch (final NumberFormatException n) {
                sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.generic.nan", args[8]));
                return false;
            }
        }
        ...
        if (args.length >= 8) {
            try {
                ...
                if (pitch < 0 || pitch > 2) {
                    sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.minecraft.playsound.invalid.pitch", args[7]));
                    return false;
                } else if (pitch < 0.5) {
                    pitch = 0.5;
                }
                ...
                sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.generic.nan", args[7]));
                return false;
            }
        }
        ...
        if (args.length >= 7) {
            try {
                ...
                sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.generic.nan", args[6]));
                return false;
            }
        }
        ...
        for (final GlowPlayer target : targets) {
            ...
            try {
                ...
                sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.minecraft.playsound.invalid.position", args[3], args[4], args[5]));
                return false;
            }
            ...
            if (targetLocation.distanceSquared(soundLocation) > Math.pow(volume, 2)) {
                if (minimumVolume <= 0) {
                    sender.sendMessage(ChatColor.RED + GlowServer.lang.getString(sender, "command.minecraft.playsound.toofar", target.getName()));
                    return false;
                } else {
