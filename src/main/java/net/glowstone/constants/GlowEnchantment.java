...
public final class GlowEnchantment extends Enchantment implements Choice {
    ...
    private enum Impl {
        ...
        THORNS(7, "Thorns", 3, Rarity.VERY_RARE, 10, 20, 50, EnchantmentTarget.ARMOR_TORSO,
        ...
        BINDING_CURSE(10, "Curse of Binding", 1, Rarity.VERY_RARE, true, 25, 0, 25,
        ...
        KNOCKBACK(19, "Knockback", 2, Rarity.UNCOMMON, 5, 20, 50, EnchantmentTarget.WEAPON,
                "minecraft:knockback"),
        FIRE_ASPECT(20, "Fire Aspect", 2, Rarity.RARE, 10, 20, 50, EnchantmentTarget.WEAPON,
                "minecraft:fire_aspect"),
        LOOT_BONUS_MOBS(21, "Looting", 3, Rarity.RARE, 15, 9, 50, EnchantmentTarget.WEAPON,
            "minecraft:looting"),
        SWEEPING_EDGE(22, "Sweeping Edge", 3, Rarity.RARE, 5, 9, 15, EnchantmentTarget.WEAPON,
            "minecraft:sweeping"),
        DIG_SPEED(32, "Efficiency", 5, Rarity.COMMON, 1, 10, 50, EnchantmentTarget.TOOL, DIGGING_TOOLS, "minecraft:efficiency"),
        SILK_TOUCH(33, "Silk Touch", 1, Rarity.VERY_RARE, false, 15, 0, 50,
            EnchantmentTarget.TOOL, BASE_TOOLS, Group.DIG, "minecraft:silk_touch"),
        DURABILITY(34, "Unbreaking", 3, Rarity.UNCOMMON, 5, 8, 50, EnchantmentTarget.TOOL,
        ...
        ARROW_FIRE(50, "Flame", 1, Rarity.RARE, 20, 0, 30, EnchantmentTarget.BOW,
            "minecraft:flame"),
        ARROW_INFINITE(51, "Infinity", 1, Rarity.VERY_RARE, 20, 0, 30, EnchantmentTarget.BOW, Group.USAGE,
            "minecraft:infinity"),
        LUCK(61, "Luck of the Sea", 3, Rarity.RARE, 15, 9, 50, EnchantmentTarget.FISHING_ROD,
            "minecraft:luck_of_the_sea"),
        LURE(62, "Lure", 3, Rarity.RARE, 15, 9, 50, EnchantmentTarget.FISHING_ROD,
            "minecraft:lure"),
        LOYALTY(65, "Loyalty", 3, Rarity.UNCOMMON, 17, 5, 23, 50, EnchantmentTarget.TRIDENT, Group.TRIDENT_THROW, "minecraft:loyalty"),
        IMPALING(66, "Impaling", 5, Rarity.RARE, 1, 8, 20, EnchantmentTarget.TRIDENT, "minecraft:impaling"),
        RIPTIDE(67, "Riptide", 3, Rarity.RARE, 17, 10, 13, 50, EnchantmentTarget.TRIDENT, Group.TRIDENT_THROW, "minecraft:riptide"),
        CHANNELING(68, "Channeling", 1, Rarity.VERY_RARE, 25, 0, 25, EnchantmentTarget.TRIDENT, "minecraft:channeling"),
        MENDING(70, "Mending", 1, Rarity.RARE, 25, 0, 50, EnchantmentTarget.ALL, Group.USAGE,
                "minecraft:mending"),
        VANISHING_CURSE(71, "Curse of Vanishing", 1, Rarity.VERY_RARE, true, 25, 0, 25,
        ...
        Impl(int id, String name, int max, Rarity rarity, int minValue, int minInc, int maxInc, EnchantmentTarget target, MatcherAdapter matcherAdapter, String vanillaId) {
        ...
        Impl(int id, String name, int max, Rarity rarity, int minValue, int minInc, int maxInc, int maxValue, EnchantmentTarget target, Group group, String vanillaId) {
