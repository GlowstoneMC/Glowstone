...
public class GlowAnvil extends AbstractBlockData implements Directional {

    private BlockFace facing;

    public GlowAnvil(Material material){
        this(material, BlockFace.NORTH);
    }

    public GlowAnvil(Material material, BlockFace face){
        super(material);
        this.setFacing(face);
    }
    ...
    public @NotNull BlockData clone() {
        return new GlowAnvil(this.getMaterial(), this.facing);
    }
}
