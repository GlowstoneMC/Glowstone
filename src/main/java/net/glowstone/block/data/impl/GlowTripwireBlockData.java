...
public class GlowTripwireBlockData extends AbstractBlockData implements GlowPowered, GlowMultipleFaces, GlowAttachable, Tripwire {
    public GlowTripwireBlockData(Material material) {
    ...
    public @NotNull BlockData clone() {
        GlowTripwireBlockData tripwire = new GlowTripwireBlockData(this.getMaterial());
