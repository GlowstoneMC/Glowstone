...
public final class Blocks {
    ...
    public static final GlowBlockType STONE = of("stone", 1).enumProperty("variant", StoneType.class, EnumNames.stone()).behavior(new RequiresTool(ToolType.PICKAXE), new StoneDrops()).register();
    public static final GlowBlockType GRASS = of("grass", 2).behavior(new DirectDrops(Material.GRASS)).register();
    public static final GlowBlockType DIRT = of("dirt", 3).enumProperty("variant", DirtType.class, EnumNames.dirt()).behavior(new DirtDrops()).register();
    public static final GlowBlockType COBBLESTONE = of("cobblestone", 4).register();
    public static final GlowBlockType WOOD = of("planks", 5).enumProperty("variant", TreeSpecies.class, EnumNames.tree()).register();
    public static final GlowBlockType SAPLING = of("sapling", 6).rangeProperty("stage", 0, 1).enumProperty("type", TreeSpecies.class, EnumNames.tree()).idResolver(new SaplingIdResolver()).register();
    public static final GlowBlockType BEDROCK = of("bedrock", 7).register();
    // <- liquids
    public static final GlowBlockType SAND = of("sand", 12).enumProperty("variant", SandType.class, EnumNames.sand()).behavior(new Falling()).register();
    ...
    public static final GlowBlockType LOG = of("log", 17).enumProperty("axis", BlockAxis.class).partialProperty("variant", TreeSpecies.class, EnumNames.tree(), EnumNames.TREES_FIRST)/*.behavior(new LogPlacement())*/.register();
    public static final GlowBlockType LEAVES = of("leaves", 18).booleanProperty("check_decay").booleanProperty("decayable").partialProperty("variant", TreeSpecies.class, EnumNames.tree(), EnumNames.TREES_SECOND).behavior(new LeavesDrops()).register();
