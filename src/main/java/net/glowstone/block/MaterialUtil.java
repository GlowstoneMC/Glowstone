...
public class MaterialUtil {
    ...
    public static final ImmutableSet<Material> CONCRETE_POWDER = ImmutableSet.copyOf(EnumSet.of(
        ...
        Material.LIGHT_BLUE_CONCRETE_POWDER, Material.LIME_CONCRETE_POWDER,
        Material.ORANGE_CONCRETE_POWDER,
        Material.LIGHT_GRAY_CONCRETE_POWDER,
        Material.GRAY_CONCRETE_POWDER, Material.BROWN_CONCRETE_POWDER, Material.RED_CONCRETE_POWDER,
        Material.PURPLE_CONCRETE_POWDER,
        Material.BLUE_CONCRETE_POWDER, Material.GREEN_CONCRETE_POWDER,
    ...
    public static final ImmutableSet<Material> STAINED_GLASS_BLOCKS =
    ...
    public static final ImmutableSet<Material> PLANKS = ImmutableSet.copyOf(EnumSet.of(
        Material.OAK_PLANKS, Material.DARK_OAK_PLANKS, Material.ACACIA_PLANKS,
    ...
    public static final ImmutableSet<Material> WALL_SIGNS = ImmutableSet.copyOf(EnumSet.of(
        Material.OAK_WALL_SIGN, Material.DARK_OAK_WALL_SIGN, Material.ACACIA_WALL_SIGN,
